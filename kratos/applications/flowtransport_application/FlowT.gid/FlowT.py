...
gid_io = GidIO("FlowT",gid_mode,multifile,deformed_mesh_flag,write_conditions)


model_part_io = ModelPartIO("FlowT")         # we set the name of the .mdpa file 
...
f = open("FlowT"+".post.lst","w")
f.write("Single\n")
f.write("FlowT"+"_0.post.res")
f.close()
#### SOLO EN UNSTEADY STATE
