...
class SolverSettings:
    ...
    unknown_variable_1 = "HEAD_LEVEL"
    unknown_variable_2 = "CONCENTRATION"

    density_variable = "SPECIFIC_STORAGE"
    projection_variable = "PERMEABILITY_WATER"
    volume_source_variable = "DENSITY"
    diffusion_variable = "POROSITY"
    surface_source_variable = "DIFFUSION_COEFFICIENT"
