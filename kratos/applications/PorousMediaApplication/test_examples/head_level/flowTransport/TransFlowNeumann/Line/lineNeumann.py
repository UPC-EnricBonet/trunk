...
model_part.SetBufferSize(2)
 ...
 # we add the DoFs  
fractional_solver.AddDofs(model_part)

print ("Time steps values on each time for unkown=2 (Buffer size)") 

#creating flow solver (custom)
solver = fractional_solver.FractionalSolver1(model_part,domain_size)
## This part is contained is for the FractionalSolver not included at flowSolver.py
solver.time_order = 1
solver.echo_level = 3
