...
output_file_name = "result_flowNeumannNodes"
input_file_name = "flowNeumannNodes"
...
# Option 2 instead adding at the mdpa...applying a BC of flow rate 20 to each node that have the below condition
#for node in model_part.Nodes:
#    if(node.Y > 0.999):
#        node.SetSolutionStepValue(FLOW_RATE, 0, 20.0);
