...
gid_io = GidIO("PurePrueba",gid_mode,multifile,deformed_mesh_flag,write_conditions) #output will be the name of the output files

model_part_io = ModelPartIO("PurePrueba")             # we set the name of the .mdpa file  
...
f = open("PurePrueba"+".post.lst","w")
f.write("Single\n")
f.write("PurePrueba"+"_0.post.res")
f.close()
