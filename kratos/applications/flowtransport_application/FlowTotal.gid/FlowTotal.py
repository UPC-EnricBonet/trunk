...
gid_io = GidIO("FlowTotal",gid_mode,multifile,deformed_mesh_flag,write_conditions)


model_part_io = ModelPartIO("FlowTotal")         # we set the name of the .mdpa file 
...
f = open("FlowTotal"+".post.lst","w")
f.write("Single\n")
f.write("FlowTotal"+"_0.post.res")
f.close()
#### SOLO EN UNSTEADY STATE
