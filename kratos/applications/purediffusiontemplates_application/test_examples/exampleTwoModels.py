...
fluid_model_part.SetBufferSize(1)
thermal_model_part.SetBufferSize(1)
...
for node in thermal_model_part.Nodes:
   ...
   if (node.X>0.99999 and node.Y>0.9999):
      node.SetSolutionStepValue(POINT_HEAT_SOURCE,0,10.0)
